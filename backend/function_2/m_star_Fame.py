...
# M* สามารถปรับให้คำนึงถึงความหนาแน่นและกระจายการจราจร
...
# ความแตกต่างหลักคือ M* จะคำนวณเส้นทางสำหรับหลายตัวแทนพร้อมกัน ในขณะที่ A* คำนวณเส้นทางสำหรับตัวแทนเดียว
